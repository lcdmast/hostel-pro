export declare const ElBreadcrumb: import("element-plus/es/utils").SFCWithInstall<import("vue").DefineComponent<{
    ...
    BreadcrumbItem: import("vue").DefineComponent<{
        ...
        to: import("element-plus/es/utils").EpPropMergeType<(new (...args: any[]) => import("vue-router").RouteLocationRaw & {}) | (() => import("vue-router").RouteLocationRaw) | ((new (...args: any[]) => import("vue-router").RouteLocationRaw & {}) | (() => import("vue-router").RouteLocationRaw))[], unknown, unknown>;
    }>;
};
