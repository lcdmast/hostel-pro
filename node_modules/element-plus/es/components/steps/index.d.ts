export declare const ElSteps: import("element-plus/es/utils").SFCWithInstall<import("vue").DefineComponent<{
    ...
    finishStatus: import("element-plus/es/utils").EpPropMergeType<StringConstructor, "success" | "error" | "wait" | "process" | "finish", unknown>;
    processStatus: import("element-plus/es/utils").EpPropMergeType<StringConstructor, "success" | "error" | "wait" | "process" | "finish", unknown>;
}>> & {
    Step: import("vue").DefineComponent<{
        ...
        title: string;
        description: string;
        status: import("element-plus/es/utils").EpPropMergeType<StringConstructor, "" | "success" | "error" | "wait" | "process" | "finish", unknown>;
    }>;
};
