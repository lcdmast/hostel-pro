import { defineComponent, ref, computed, watch, nextTick, resolveComponent, openBlock, createElementBlock, normalizeClass, createElementVNode, toDisplayString, createCommentVNode, Fragment, renderList, createVNode } from 'vue';
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("table", {
    ...
    cellspacing: "0",
    cellpadding: "0",
    class: normalizeClass([_ctx.ns.b(), { "is-week-mode": _ctx.selectionMode === "week" }]),
    ...
    createElementVNode("tbody", _hoisted_2, [
      createElementVNode("tr", null, [
        _ctx.showWeekNumber ? (openBlock(), createElementBlock("th", _hoisted_3, toDisplayString(_ctx.t("el.datepicker.week")), 1)) : createCommentVNode("v-if", true),
      ...
      (openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.rows, (row, key) => {
        return openBlock(), createElementBlock("tr", {
          key,
          class: normalizeClass([_ctx.ns.e("row"), { current: _ctx.isWeekActive(row[1]) }])
        }, [
