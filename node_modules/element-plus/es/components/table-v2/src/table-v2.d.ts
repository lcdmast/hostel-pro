...
declare const TableV2: import("vue").DefineComponent<{
    ...
    rowKey: import("../../../utils").EpPropMergeType<(new (...args: any[]) => import("./types").KeyType & {}) | (() => import("./types").KeyType) | ((new (...args: any[]) => import("./types").KeyType & {}) | (() => import("./types").KeyType))[], unknown, unknown>;
    ...
    headerHeight: import("../../../utils").EpPropMergeType<(new (...args: any[]) => (number | number[]) & {}) | (() => number | number[]) | ((new (...args: any[]) => (number | number[]) & {}) | (() => number | number[]))[], unknown, unknown>;
    cache: number;
    footerHeight: number;
    indentSize: number;
    iconSize: number;
    sortState: import("./types").SortState;
