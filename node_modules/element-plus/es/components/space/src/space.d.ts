...
declare const _default: import("vue").DefineComponent<{
    ...
    fill: import("element-plus/es/utils").EpPropMergeType<BooleanConstructor, unknown, unknown>;
    style: StyleValue;
    wrap: import("element-plus/es/utils").EpPropMergeType<BooleanConstructor, unknown, unknown>;
    direction: import("element-plus/es/utils").EpPropMergeType<StringConstructor, "horizontal" | "vertical", unknown>;
    class: import("element-plus/es/utils").EpPropMergeType<(new (...args: any[]) => (string | string[] | Record<string, boolean>) & {}) | (() => string | string[] | Record<string, boolean>) | ((new (...args: any[]) => (string | string[] | Record<string, boolean>) & {}) | (() => string | string[] | Record<string, boolean>))[], unknown, unknown>;
    alignment: string;
    spacer: VNodeChild;
    fillRatio: number;
}>;
