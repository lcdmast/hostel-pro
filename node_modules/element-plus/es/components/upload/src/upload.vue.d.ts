...
declare const _default: import("vue").DefineComponent<{
    ...
    uploadRef: import("vue").ShallowRef<({
        ...
        $props: Partial<{
            ...
            disabled: boolean;
            name: string;
            drag: import("../../../utils").EpPropMergeType<BooleanConstructor, unknown, unknown>;
            multiple: import("../../../utils").EpPropMergeType<BooleanConstructor, unknown, unknown>;
            ...
            action: string;
            method: string;
            showFileList: import("../../../utils").EpPropMergeType<BooleanConstructor, unknown, unknown>;
            accept: string;
            fileList: import("./upload").UploadUserFile[];
            autoUpload: import("../../../utils").EpPropMergeType<BooleanConstructor, unknown, unknown>;
            listType: import("../../../utils").EpPropMergeType<StringConstructor, "text" | "picture" | "picture-card", unknown>;
    ...
    UploadList: import("vue").DefineComponent<{
        ...
        ElProgress: import("../../../utils").SFCWithInstall<import("vue").DefineComponent<{
            ...
            type: import("../../../utils").EpPropMergeType<StringConstructor, "circle" | "line" | "dashboard", unknown>;
            color: import("../../../utils").EpPropMergeType<(new (...args: any[]) => (string | import("../..").ProgressFn | import("../..").ProgressColor[]) & {}) | (() => string | import("../..").ProgressFn | import("../..").ProgressColor[]) | ((new (...args: any[]) => (string | import("../..").ProgressFn | import("../..").ProgressColor[]) & {}) | (() => string | import("../..").ProgressFn | import("../..").ProgressColor[]))[], unknown, unknown>;
            width: number;
            strokeLinecap: import("../../../utils").EpPropMergeType<(new (...args: any[]) => ("round" | "inherit" | "butt" | "square") & {}) | (() => "round" | "inherit" | "butt" | "square") | ((new (...args: any[]) => ("round" | "inherit" | "butt" | "square") & {}) | (() => "round" | "inherit" | "butt" | "square"))[], unknown, unknown>;
            strokeWidth: number;
            indeterminate: import("../../../utils").EpPropMergeType<BooleanConstructor, unknown, unknown>;
            format: import("../..").ProgressFn;
            percentage: number;
            status: import("../../../utils").EpPropMergeType<StringConstructor, "" | "success" | "warning" | "exception", unknown>;
            duration: number;
            textInside: import("../../../utils").EpPropMergeType<BooleanConstructor, unknown, unknown>;
            showText: import("../../../utils").EpPropMergeType<BooleanConstructor, unknown, unknown>;
        }>> & Record<string, any>;
    }, unknown, {}, {}, import("vue").ComponentOptionsMixin, import("vue").ComponentOptionsMixin, {
