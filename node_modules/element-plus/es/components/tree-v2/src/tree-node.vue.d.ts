declare const _default: import("vue").DefineComponent<{
    ...
    expanded: import("../../../utils").EpPropMergeType<BooleanConstructor, unknown, unknown>;
    current: import("../../../utils").EpPropMergeType<BooleanConstructor, unknown, unknown>;
    indeterminate: import("../../../utils").EpPropMergeType<BooleanConstructor, unknown, unknown>;
    checked: import("../../../utils").EpPropMergeType<BooleanConstructor, unknown, unknown>;
    node: import("./types").TreeNode;
    showCheckbox: import("../../../utils").EpPropMergeType<BooleanConstructor, unknown, unknown>;
    hiddenExpandIcon: import("../../../utils").EpPropMergeType<BooleanConstructor, unknown, unknown>;
}>;
