export declare const ElRow: import("element-plus/es/utils").SFCWithInstall<import("vue").DefineComponent<{
    ...
    justify: import("element-plus/es/utils").EpPropMergeType<StringConstructor, "center" | "space-around" | "space-between" | "space-evenly" | "end" | "start", unknown>;
    tag: string;
    gutter: number;
    align: import("element-plus/es/utils").EpPropMergeType<StringConstructor, "top" | "bottom" | "middle", unknown>;
}>> & Record<string, any>;
