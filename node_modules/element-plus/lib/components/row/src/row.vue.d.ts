...
declare const _default: import("vue").DefineComponent<{
    ...
    justify: import("../../../utils").EpPropMergeType<StringConstructor, "center" | "space-around" | "space-between" | "space-evenly" | "end" | "start", unknown>;
    tag: string;
    gutter: number;
    align: import("../../../utils").EpPropMergeType<StringConstructor, "top" | "bottom" | "middle", unknown>;
}>;
