declare const _default: import("vue").DefineComponent<{
    ...
    ElSkeletonItem: import("vue").DefineComponent<{
        ...
        variant: import("../../../utils").EpPropMergeType<StringConstructor, "text" | "button" | "circle" | "caption" | "image" | "rect" | "h1" | "h3" | "p", unknown>;
    }>;
}, unknown, {}, {}, import("vue").ComponentOptionsMixin, import("vue").ComponentOptionsMixin, Record<string, any>, string, import("vue").VNodeProps & import("vue").AllowedComponentProps & import("vue").ComponentCustomProps, Readonly<import("vue").ExtractPropTypes<{
    readonly animated: import("../../../utils").EpPropFinalized<BooleanConstructor, unknown, unknown, false, boolean>;
    readonly count: import("../../../utils").EpPropFinalized<NumberConstructor, unknown, unknown, 1, boolean>;
    ...
    loading: import("../../../utils").EpPropMergeType<BooleanConstructor, unknown, unknown>;
    animated: import("../../../utils").EpPropMergeType<BooleanConstructor, unknown, unknown>;
    count: number;
    rows: number;
}>;
