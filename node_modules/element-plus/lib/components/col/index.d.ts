export declare const ElCol: import("element-plus/es/utils").SFCWithInstall<import("vue").DefineComponent<{
    ...
    span: number;
    pull: number;
    xs: import("element-plus/es/utils").EpPropMergeType<(new (...args: any[]) => import("./src/col").ColSize & {}) | (() => import("./src/col").ColSize) | ((new (...args: any[]) => import("./src/col").ColSize & {}) | (() => import("./src/col").ColSize))[], unknown, unknown>;
    sm: import("element-plus/es/utils").EpPropMergeType<(new (...args: any[]) => import("./src/col").ColSize & {}) | (() => import("./src/col").ColSize) | ((new (...args: any[]) => import("./src/col").ColSize & {}) | (() => import("./src/col").ColSize))[], unknown, unknown>;
    md: import("element-plus/es/utils").EpPropMergeType<(new (...args: any[]) => import("./src/col").ColSize & {}) | (() => import("./src/col").ColSize) | ((new (...args: any[]) => import("./src/col").ColSize & {}) | (() => import("./src/col").ColSize))[], unknown, unknown>;
    lg: import("element-plus/es/utils").EpPropMergeType<(new (...args: any[]) => import("./src/col").ColSize & {}) | (() => import("./src/col").ColSize) | ((new (...args: any[]) => import("./src/col").ColSize & {}) | (() => import("./src/col").ColSize))[], unknown, unknown>;
    xl: import("element-plus/es/utils").EpPropMergeType<(new (...args: any[]) => import("./src/col").ColSize & {}) | (() => import("./src/col").ColSize) | ((new (...args: any[]) => import("./src/col").ColSize & {}) | (() => import("./src/col").ColSize))[], unknown, unknown>;
}>> & Record<string, any>;
