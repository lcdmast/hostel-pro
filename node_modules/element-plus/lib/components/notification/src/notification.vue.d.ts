...
declare const _default: import("vue").DefineComponent<{
    ...
    icon: import("element-plus/es/utils").EpPropMergeType<(new (...args: any[]) => (string | Comment) & {}) | (() => string | Comment) | ((new (...args: any[]) => (string | Comment) & {}) | (() => string | Comment))[], unknown, unknown>;
    ...
    id: string;
    offset: number;
    position: import("element-plus/es/utils").EpPropMergeType<StringConstructor, "top-right" | "top-left" | "bottom-right" | "bottom-left", unknown>;
    title: string;
    onClick: () => void;
    customClass: string;
