export declare const ElMenu: import("element-plus/es/utils").SFCWithInstall<import("vue").DefineComponent<{
    ...
    MenuItem: import("vue").DefineComponent<{
        ...
        disabled: boolean;
        index: import("element-plus/es/utils").EpPropMergeType<(new (...args: any[]) => string & {}) | (() => string | null) | ((new (...args: any[]) => string & {}) | (() => string | null))[], unknown, unknown>;
    }>;
    ...
    SubMenu: import("vue").DefineComponent<{
        ...
        showTimeout: number;
        hideTimeout: number;
        popperAppendToBody: import("element-plus/es/utils").EpPropMergeType<BooleanConstructor, unknown, unknown>;
        popperOffset: number;
    }>;
};
