declare const _default: import("vue").DefineComponent<{
    ...
    disabled: boolean;
    name: import("element-plus/es/utils").EpPropMergeType<(new (...args: any[]) => import("./collapse").CollapseActiveName & {}) | (() => import("./collapse").CollapseActiveName) | ((new (...args: any[]) => import("./collapse").CollapseActiveName & {}) | (() => import("./collapse").CollapseActiveName))[], unknown, unknown>;
    title: string;
}>;
