declare const _default: import("vue").DefineComponent<{
    ...
    checkStrictly: import("../../../utils").EpPropMergeType<BooleanConstructor, unknown, unknown>;
    accordion: import("../../../utils").EpPropMergeType<BooleanConstructor, unknown, unknown>;
    indent: number;
    perfMode: import("../../../utils").EpPropMergeType<BooleanConstructor, unknown, unknown>;
    showCheckbox: import("../../../utils").EpPropMergeType<BooleanConstructor, unknown, unknown>;
    defaultCheckedKeys: import("./types").TreeKey[];
    defaultExpandedKeys: import("./types").TreeKey[];
    expandOnClickNode: import("../../../utils").EpPropMergeType<BooleanConstructor, unknown, unknown>;
    checkOnClickNode: import("../../../utils").EpPropMergeType<BooleanConstructor, unknown, unknown>;
    highlightCurrent: import("../../../utils").EpPropMergeType<BooleanConstructor, unknown, unknown>;
}>;
